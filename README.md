...
| 401 | Không có Bearer token hoặc token không hợp lệ | `{ "success": false, "error": "Unauthorized", "statusCode": 401 }` |
...
| 400 | Thiếu messages trong body, format messages sai, thiếu prompt (test endpoint) | `{ "success": false, "error": "Invalid request format", "statusCode": 400 }` |
| 401 | Token không hợp lệ (only guarded test endpoints) | `{ "success": false, "error": "Unauthorized", "statusCode": 401 }` |
| 403 | Không có quyền admin (only guarded test endpoints) | `{ "success": false, "error": "Forbidden resource", "statusCode": 403 }` |
...
| 400 | Không có token trong header | `{ "success": false, "error": "Missing authorization token", "statusCode": 400 }` |

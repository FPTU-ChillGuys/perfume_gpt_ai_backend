...
export class Migration20260304155521 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`alter table "admin_instruction" add column "is_active" boolean not null default true;`);

    this.addSql(`alter table "aiacceptance" add column "is_active" boolean not null default true;`);

    this.addSql(`alter table "common" add column "is_active" boolean not null default true;`);

    this.addSql(`alter table "conversation" add column "is_active" boolean not null default true;`);
    ...
    this.addSql(`alter table "review_summary_log" add column "is_active" boolean not null default true;`);

    this.addSql(`alter table "user_log" add column "is_active" boolean not null default true;`);

    this.addSql(`alter table "user_log_summary" add column "is_active" boolean not null default true;`);

    this.addSql(`alter table "user_message_log" add column "is_active" boolean not null default true;`);

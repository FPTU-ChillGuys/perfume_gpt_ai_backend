...
export class Migration20260315083426 extends Migration {
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`create table "user_quiz_log" ("id" uuid not null default gen_random_uuid(), "created_at" timestamptz not null, "updated_at" timestamptz not null, "is_active" boolean not null default true, "quiz_ques_ans_detail_id" uuid null, "user_log_id" uuid not null, constraint "user_quiz_log_pkey" primary key ("id"));`);

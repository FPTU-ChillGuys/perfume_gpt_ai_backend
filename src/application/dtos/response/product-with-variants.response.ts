...
export class ProductVariantResponse {
  ...
  @ApiProperty({
    description: 'Barcode',
    example: 'BAR-1A78A674-6DE6-4C80-93C2-5717419684E7'
  })
  barcode!: string;
  ...
  @ApiProperty({
    ...
    type: () => [VariantMediaResponse]
  })
  media!: VariantMediaResponse[];

  /** Danh sách thuộc tính của variant */
  @ApiProperty({
    description: 'Danh sách thuộc tính variant',
  ...
  @ApiPropertyOptional({
    description: 'URL hình ảnh chính của variant',
    nullable: true
  })
  url!: string | null;
}

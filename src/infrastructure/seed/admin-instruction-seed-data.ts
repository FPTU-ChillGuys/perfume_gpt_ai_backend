...
## VÌ SAO CẦN CÁC BƯỚC NÀY
- Chỉ 1 lần gọi tool để tránh lệch dữ liệu giữa các lần gọi.
- Bám sát mảng products để chống ảo giác và sai lệch tên/ID.
- Tách message và products để hệ thống downstream parse ổn định.
...
- Có thay đổi ID/tên sản phẩm gốc từ tool không?
...
- Giới hạn số lần gọi tool để ổn định dữ liệu và chi phí.
- Có fallback khi dữ liệu trống để không bịa lịch sử.
...
## TỰ KIỂM TRA TRƯỚC KHI TRẢ KẾT QUẢ
- Có gợi ý sản phẩm trái giới tính/gu chính đã mua trước đây không?
- Có nhắc sản phẩm không tồn tại trong products không?
- Nếu không có lịch sử, message đã chuyển đúng về thư tri ân chung chưa?`
  },
...
## VÌ SAO CẦN CÁC BƯỚC NÀY
- Tốc độ bán là tín hiệu chính để quyết định lượng nhập.

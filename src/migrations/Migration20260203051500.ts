...
export class Migration20260203051500 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "user_survey_log" drop constraint "user_survey_log_survey_ques_ans_detail_id_foreign";`);
    ...
    this.addSql(`alter table "user_survey_log" alter column "survey_ques_ans_detail_id" drop default;`);
    this.addSql(`alter table "user_survey_log" alter column "survey_ques_ans_detail_id" type uuid using ("survey_ques_ans_detail_id"::text::uuid);`);
    this.addSql(`alter table "user_survey_log" alter column "survey_ques_ans_detail_id" drop not null;`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "user_survey_log" alter column "survey_ques_ans_detail_id" drop default;`);
    this.addSql(`alter table "user_survey_log" alter column "survey_ques_ans_detail_id" type uuid using ("survey_ques_ans_detail_id"::text::uuid);`);
    this.addSql(`alter table "user_survey_log" alter column "survey_ques_ans_detail_id" set not null;`);
    this.addSql(`alter table "user_survey_log" add constraint "user_survey_log_survey_ques_ans_detail_id_foreign" foreign key ("survey_ques_ans_detail_id") references "survey_question_answer_detail" ("id") on update cascade;`);
  }

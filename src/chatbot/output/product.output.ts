...
export const productCardOutputItemSchema = z.object({
  ...
  reasoning: z
    ...
    .nullable()
    .describe(
      'Giải thích lý do lựa chọn sản phẩm này cho người dùng dựa trên nhu cầu của họ.'
    ),
  source: z
    .string()
    .nullable()
    .describe(
      'Nguồn gợi ý sản phẩm (ví dụ: RECOMMENDATION_RESULTS, SEARCH_RESULTS, vv.)'
    )
});
...
export type ProductCardVariantOutput = z.infer<
  typeof productCardVariantOutputSchema
>;

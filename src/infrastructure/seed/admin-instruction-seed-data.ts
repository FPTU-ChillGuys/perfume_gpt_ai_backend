...
- Trích xuất độ lưu hương (minLongevity) và độ tỏa hương (minSillage) dựa trên các tính từ:
- Longevity: "lâu/rất lâu": 8, "tạm ổn": 6, "cả ngày": 10.
- Sillage: "tỏa xa/rất xa": 3, "gần/thoang thoảng": 1.

# LƯU Ý QUAN TRỌNG
- Nếu không có thông tin cho một trường nào đó, hãy để trống hoặc null.
- TUYỆT ĐỐI không gán giới tính (Unisex/Nam/Nữ) nếu người dùng không nhắc tới.

...
export class Migration20260201101736 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "user_survey_log" ("id" uuid not null default gen_random_uuid(), "created_at" timestamptz not null, "updated_at" timestamptz not null, "survey_ques_ans_detail_id" uuid not null, "user_log_id" uuid not null, constraint "user_survey_log_pkey" primary key ("id"));`);

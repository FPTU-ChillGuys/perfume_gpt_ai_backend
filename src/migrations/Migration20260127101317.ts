...
export class Migration20260127101317 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "quiz_answer" drop constraint "quiz_answer_questionId_foreign";`);
    ...
    this.addSql(`alter table "quiz_answer" drop column "questionId";`);

    this.addSql(`alter table "quiz_answer" alter column "question_id" drop default;`);
    this.addSql(`alter table "quiz_answer" alter column "question_id" type uuid using ("question_id"::text::uuid);`);
    this.addSql(`alter table "quiz_answer" add constraint "quiz_answer_question_id_foreign" foreign key ("question_id") references "quiz_question" ("id") on update cascade on delete cascade;`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "quiz_answer" alter column "question_id" type text using ("question_id"::text);`);

    this.addSql(`alter table "quiz_answer" drop constraint "quiz_answer_question_id_foreign";`);
    ...
    this.addSql(`alter table "quiz_answer" add column "questionId" uuid not null;`);
    this.addSql(`alter table "quiz_answer" alter column "question_id" type varchar(255) using ("question_id"::varchar(255));`);
